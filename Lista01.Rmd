...
```
Faça uma análise gráfica dos resíduos e comente se as suposições do modelo são satisfeitas.
```{r}
...
#alfa 5%
summary (model_gpa)
# p-valor de ACT (slope) é menor do que Alpha, logo rejeito HO e concluo que beta1 nao é zero. Logo, existe relacao linear entre as variaveis
```
